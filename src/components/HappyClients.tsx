    ...
    return (
        <div className="payment-system pb-20">
            <div className="grid md:grid-cols-2 mt-20 items-center md:gap-8 gap-6 font-[sans-serif] max-w-6xl max-md:max-w-md mx-auto">
                ...
                >
                    <motion.h2 className="md:text-4xl text-3xl md:leading-10 font-extrabold text-gray-800 mb-4">
                        Streamline Your Payments
                    </motion.h2>
                    <motion.p className="mt-4 text-base text-gray-600 leading-relaxed">
                ...
                >
                    <motion.img
                        src={ai}
                        className="w-[1000px] h-[350px] object-cover rounded-lg hover:shadow-2x1 mx-auto hover:shadow-2xl transition-shadow duration-300"
